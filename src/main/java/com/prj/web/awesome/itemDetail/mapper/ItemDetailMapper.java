...
public interface ItemDetailMapper {
    ...
    @Select("select i.item_id, i.item_name, i.item_price, img.img_name from item i Join image img on i.item_id = img.item_id where img.img_div_flag = 'm' and i.ctgr_cd = #{ctgr_cd}")
